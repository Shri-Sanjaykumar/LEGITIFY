        ...
        >
          ...
          {(!collapsed || isMobile) && (
            <motion.button
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="p-1.5 rounded-md text-[var(--text-tertiary)] hover:text-[var(--danger)] hover:bg-[rgba(239,68,68,0.1)] transition-colors"
              aria-label="Logout"
            >
      ...
      {!isMobile && (
        <div className="px-3 pb-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] hover:bg-[var(--bg-elevated)] transition-all duration-200"
          >
            {collapsed ? (
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden p-2.5 rounded-lg bg-[var(--bg-card)] border border-[var(--border-primary)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors"
        ...
        {mobileOpen && (
          <>
            ...
            >
              <button
                onClick={() => setMobileOpen(false)}
                className="absolute top-5 right-4 p-2 rounded-lg text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-elevated)] transition-colors"
